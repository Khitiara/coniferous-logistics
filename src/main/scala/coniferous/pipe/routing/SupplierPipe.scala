...
import coniferous.pipe.{BlockPipe, RoutedItem, SidedPipe}
import net.minecraft.block.BlockState
import net.minecraft.util.math.{BlockPos, Direction}
import net.minecraft.world.World

case class SupplierPipe(pos: BlockPos, world: World) extends SidedPipe {
  private var mSide: Direction = Direction.DOWN

  override def mainSide: Direction = mSide

  override def name: String = "supplier"
